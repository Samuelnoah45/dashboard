    ...
    >
      ...
      <div class="flex items-center flex-none lg:space-x-4 space-x-2">
        ...
        <Menu as="div" class="relative inline-block text-left space-x-1">
          <MenuButton
            @click="openMenu()"
            class="flex bg-[#EEF0F3] space-x-2 items-center p-1 rounded-full justify-end"
          >
            <div
          ...
          >
            <MenuItems
              class="absolute bg-[#EEF0F3] min-w-[100px] w-full right-4"
            >
              <div class="flex flex-col">
                <MenuItem
                  class="hover:text-primary border px-2"
                  v-slot="{ active }"
                >
