  ...
  <div class="relative">
    ...
    <div class="relative rounded-md shadow-sm font-body">
      ...
      <input
        ...
        :class="[
          errorMessage
            ? 'focus:ring-red-500 focus:border-red-500 hover:border-red-500 border-red-500 border px-2'
            : 'focus:ring-new-tale focus:border-new-tale hover:border-new-tale/70 border-gray-300 border px-2',
      ...
      >
        ...
        <Icon name="tabler:chevron-down" width="25" height="25" />
      </div>
      <div
    ...
    >
      <li
        ...
        class="border-b border-gray-200 select-none relative py-3 px-3 hover:bg-blue-50 text-gray-600 cursor-pointer overflow-auto"
      >
        <div
          ...
          :class="[
            labelClass
              ? labelClass
              : 'text-secondary font-normal block truncate font-body',
          ]"
        >
