...
import { renderToString } from 'file:///home/sky/eyea-web-client/node_modules/vue/server-renderer/index.mjs';
...
const getServerEntry = () => import('/home/sky/eyea-web-client/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
